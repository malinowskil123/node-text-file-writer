...
let readTxtFilePath =
  'https://d1b10bmlvqabco.cloudfront.net/attach/jzx1f2uji5b2c/i1wq2u14lnc4h7/k3ab11pjnpyo/dictionary.txt'
let writeTxtFilePath =
  '/Users/lukaszmalinowski/work/cse-218/FinalProjectLMalinowski/src/input_data/'
...
writePath.on('error', (err) => {
  console.log('Path Not Found ' + writeTxtFilePath)
  writePath.end()
})
ssl.get(readTxtFilePath, (res, err) => {
